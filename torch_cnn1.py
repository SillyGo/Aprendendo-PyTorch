...
class convnet(nn.Module):
    def __init__(self):
        ...
        self.fc1 = nn.Linear(16*5*5, 120) #temos 16*5*5 logo que o tamanho final da imagem, depois de todas as transformações impostas pelas camadas de convolução e de maxpooling, será 5x5
        self.fc2 = nn.Linear(120, 84)
        self.fc3 = nn.Linear(84, 10) #nos temos 10 classes diferentes, logo, deveremos ter 10 outputs.
